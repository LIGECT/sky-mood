...
async function getWeather(city) {
  try {
    ...
    const url = new URL(
      `https://weather.visualcrossing.com/VisualCrossingWebServices/rest/services/timeline/${city}?unitGroup=metric&key=${api}&include=hours,days,current,fcst&elements=datetime,temp,humidity,conditions,description,icon,feelslike,windspeed,sunrise,sunset,precipprob`,
    );
